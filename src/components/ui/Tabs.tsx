    ...
    <div className={`tw:bg-gray-800/50 tw:backdrop-blur-sm tw:p-3 tw:rounded-2xl tw:flex tw:gap-3 tw:shadow-lg tw:border tw:border-gray-700/50 ${className}`}>
      {tabs.map((tab) => (
        <button
          ...
          className={`tw:flex-1 tw:px-6 tw:py-4 tw:rounded-xl tw:font-semibold tw:text-lg tw:transition-all tw:duration-200 tw:ease-out tw:relative ${activeTab === tab.id
